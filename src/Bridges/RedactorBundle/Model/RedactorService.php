...
namespace Bridges\RedactorBundle\Model;
...
class RedactorService extends ContainerAware
{
    ...
    {
        return $this->container->getParameter(sprintf('bridges_redactor.%s', $envName));
    }
    ...
    {
        $settings = array();
        $config = $this->container->getParameter(sprintf('bridges_redactor.%s', $envName));
