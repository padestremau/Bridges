...
namespace Bridges\RedactorBundle\DependencyInjection;
 ...
 */
class BridgesRedactorExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config as $envName => $envConfig) {
            ...
            $container->setParameter(sprintf('bridges_redactor.%s', $envName), $envConfig);
        }
